            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
                    <div class="icon-box iconbox-orange ">
                        ...
                        <h4><a>{{__("messages.airco")}} 80€</a></h4>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
                    <div class="icon-box iconbox-pink">
                        ...
                        <h4><a>{{__("messages.grootOnderhoud")}} 215€</a></h4>
                ...
                <div class="kamil col-lg-4 col-md-6 align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
                    <div class="kamil icon-box iconbox-red">
                        ...
                        <h4><a>{{__("messages.Revisie")}} 55€</a></h4>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
                    <div class="icon-box iconbox-teal">
                        ...
                        <h4><a>{{__("messages.vervangwagen")}}</a></h4>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                    <div class="member">
                        <div class="member-img">
                            <img src="{{asset('/images/Dany.jpg')}}" class="img-fluid" alt="">
                            <!--<div class="social">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <form id="contact-form" class="php-email-form" action="{{url('/../sendmail')}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="message" name="message" rows="5" data-rule="required" data-msg="Please write something for us" placeholder="{{__("messages.message")}}" value="{{ old('message') }}"></textarea>
                            <div class="validate"></div>
                        </div>
                        <div class="mb-3">
                ...
                <div class="col pt-3 w-100">
                    <iframe class="w-100" title="Google Maps" src="{{__("messages.map")}}" frameborder="0" allowfullscreen style="height: 50vh"></iframe>
                </div>
            </div>
        </div>
