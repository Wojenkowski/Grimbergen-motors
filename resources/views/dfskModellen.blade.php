        ...
        <div class="clients">
            ...
            <div class="row d-flex align-items-center justify-content-center">
                ...
                <figure>
                    ...
                    <figcaption><h2>Fengon 5</h2></figcaption>
                </figure>
            </div>
        </div>
...
-->
                <figure>
                    ...
                    <figcaption><h2>EC35</h2></figcaption>
                </figure>
                <figure>
                    <a href="http://www.dfsk.com/portal/index/vehiclemodel/id/78.html" target="_blank" rel=”noopener”><img src="{{asset('/images/DFSK/glory500.png')}}" class="img-fluid car" alt="Fengon 3" title="Fengon 3"></a>
                    <figcaption><h2>Fengon 3 (glory 500)</h2></figcaption>
                </figure>

                <figure>
                    <a href="http://www.dfsk.com/portal/index/vehiclemodel/id/50.html" target="_blank" rel=”noopener”><img src="{{asset('/images/DFSK/glory580PHEV.png')}}" class="img-fluid car" alt="glory 580 PHEV" title="glory 580 PHEV"></a>
                    <figcaption><h2>glory 580 PHEV</h2></figcaption>
                </figure>
